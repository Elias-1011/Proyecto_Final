...
private:
    ...
    static constexpr float ESPERA_MIN_TOPE   = 0.1f;
    static constexpr float ESPERA_MAX_TOPE   = 2.5f;
    static constexpr float PROB_MIN_TOPE     = 0.05f;
    static constexpr float PROB_MAX_TOPE     = 0.95f;
